...
<style>
    ...
    /* Abstract & Keywords */
    .abstract-container, .keywords-container {
...
@if(isset($acmData['table']) && count($acmData['table']['rows']) > 0)
    ...
    <div class="table-container">
        <p style="text-align: center; font-style: italic; margin-bottom: 5px;">Table 1: Evaluation Summary Based on ISO 25010 Standards</p>
