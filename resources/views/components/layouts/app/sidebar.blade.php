        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-red-950 !text-yellow-500">
            ...
            <flux:navlist variant="outline">
                ...
                @if(auth()->check() && auth()->user()->isAdmin())
                    <flux:navlist.item class="{{ request()->routeIs('dashboard') ? '!text-black' : '!text-white' }}" icon="home" :href="route('dashboard')" :current="request()->routeIs('dashboard')" >{{ __('Dashboard') }}</flux:navlist.item>
